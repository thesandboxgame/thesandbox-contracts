...
import {
    ERC777Token
} from "../../../contracts_common/src/Interfaces/ERC777Token.sol";
import {
    ERC777TokenEvents
} from "../../../contracts_common/src/Interfaces/ERC777TokenEvents.sol";
import {
    ERC777TokensSender
} from "../../../contracts_common/src/Interfaces/ERC777TokensSender.sol";
import {
    ERC777TokensRecipient
} from "../../../contracts_common/src/Interfaces/ERC777TokensRecipient.sol";
import {
    ProxyImplementation
} from "../../../contracts_common/src/BaseWithStorage/ProxyImplementation.sol";
import {ERC20BaseToken} from "../erc20/ERC20BaseToken.sol";

contract ERC777BaseToken is
    ProxyImplementation,
    ERC20BaseToken,
    /*ERC777Token,*/
    ERC777TokenEvents,
    ERC820Implementer
{
    ...
    function callSender(
        ...
        address senderImplementation = interfaceAddr(
            _from,
            "ERC777TokensSender"
        );
